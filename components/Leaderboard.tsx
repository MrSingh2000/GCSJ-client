...
function Leaderboard({ data, sortData }: Props) {
  ...
  return (
    <div className='h-full min-h-screen w-full'>
      ...
      <div className="absolute right-0 mr-5 mt-5 inline-block text-left z-10">
        <div>
        ...
        {modal && <div className="absolute right-0 w-56 mt-2 origin-top-right bg-white rounded-md shadow-lg dark:bg-gray-800 ring-1 ring-black ring-opacity-5">
          <div className="py-1 " role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
            <a href="#" onClick={() => { sortData("courses"); setModal((prev) => !prev) }} className="block px-4 py-2 text-md text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-100 dark:hover:text-white dark:hover:bg-gray-600" role="menuitem">
            ...
            <a href="#" onClick={() => { sortData("badges"); setModal((prev) => !prev) }} className="block px-4 py-2 text-md text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-100 dark:hover:text-white dark:hover:bg-gray-600" role="menuitem">
              <span className="flex flex-col">
                <span>
                  Skill Badges
                </span>
            ...
            <a href="#" onClick={() => { sortData("genai"); setModal((prev) => !prev) }} className="block px-4 py-2 text-md text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-100 dark:hover:text-white dark:hover:bg-gray-600" role="menuitem">
              <span className="flex flex-col">
                <span>
                  GenAi Game
                </span>
